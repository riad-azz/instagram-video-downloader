        ...
        <section>
          <header className="mb-8 motion-safe:animate-[animate-drop_1.5s_ease-in-out_1]">
            ...
            <p className="mb-4 text-center text-sm md:text-base">
              Free Instagram Downloader is a tool that lets you download
              Instagram content in high quality for free. You can save videos
              and reels with a few steps. Just copy and paste the Instagram URL
              and enjoy unlimited downloads with no login required.
            </p>
          </header>
        </section>
        <section>
          ...
          <p className="my-4 text-center text-sm text-gray-500 motion-safe:animate-[animate-late-fade-in_3s_ease-in-out_1] dark:text-gray-400">
            If the download opens a new page, just right click the video and
            then click `Save as video`
          </p>
        </section>
      </main>
      <Footer />
